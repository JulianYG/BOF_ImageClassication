...
for i = 1:1:numOfBuddha
    ...
    I_buddha = pcatry(strcat(root,...
        'buddha/',BUDDHA(i).name),20);
...
for i = 1:1:numOfFly
    ...
    I_butterfly = pcatry(strcat(root,...
        'butterfly/',BUTTERFLY(i).name),20);
...
for i = 1:1:numOfPlane
    ...
    I_airplanes = pcatry(strcat(root,...
        'airplanes/',AIRPLANES(i).name),20);
...
for i = 4:1:numOfBuddha
    I_buddha_test = pcatry(strcat(root,...
        'TestDataset_1/',BUDDHA_TEST(i).name),20);
...
for i = 4:1:numOfButterfly
    I_butterfly_test = pcatry(strcat(root,...
        'TestDataset_2/',BUTTERFLY_TEST(i).name),20);
...
for i = 4:1:numOfAirplane
    I_airplanes_test = pcatry(strcat(root,...
